...
<table class="table" style="width: 50%; margin-left:auto; margin-right: auto">
    ...
    <tbody>
      <h1 style="width: 50%; margin-left:auto; margin-right: auto" >Book</h1>
      <a class="btn btn-primary" href="/posts/create" role="button" style="margin-left: 25%; margin-bottom: 10px; ">Add Book</a>
